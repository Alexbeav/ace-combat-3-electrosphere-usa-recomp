...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "ace-combat-3-electrosphere-usa-",
    .project_root_env = "ACE_COMBAT_3_ELECTROSPHERE_USA_RECOMP_PROJECT_ROOT",
    .build_dir_env = "ACE_COMBAT_3_ELECTROSPHERE_USA_RECOMP_BUILD_DIR",
    .force_setup_env = "ACE_COMBAT_3_ELECTROSPHERE_USA_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_009.72_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Ace_Combat_3__Electrosphere__USA__Recompiled",
    .prepare_note =
