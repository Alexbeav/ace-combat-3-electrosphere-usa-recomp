# Ace Combat 3: Electrosphere (USA) Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/ace-combat-3-electrosphere-usa-recomp/total)](https://github.com/Alexbeav/ace-combat-3-electrosphere-usa-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/ace-combat-3-electrosphere-usa-recomp/latest/total)](https://github.com/Alexbeav/ace-combat-3-electrosphere-usa-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/ace-combat-3-electrosphere-usa-recomp)](https://github.com/Alexbeav/ace-combat-3-electrosphere-usa-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Ace Combat 3: Electrosphere (USA)** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Ace Combat 3: Electrosphere (USA).
...
Zip prefix for CI artifacts: `Ace-Combat-3-Electrosphere-USA-Recomp`.
...
The `v0.3.3` source uses `Ace_Combat_3__Electrosphere__USA__Recompiled` in CMake, the setup relaunch, and the packager.
