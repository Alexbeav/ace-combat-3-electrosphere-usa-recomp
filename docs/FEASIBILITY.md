...
The supported serial set is $(@{ordinal=20; slug=ace-combat-3-electrosphere-usa; title=Ace Combat 3: Electrosphere (USA); serials=System.Object[]; expected_disc_count=1; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses
