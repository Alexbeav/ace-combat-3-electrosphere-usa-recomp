# Ace Combat 3: Electrosphere (USA) knowledge report

- Date: 2026-08-31
- Retail identity: USA NTSC-U `SLUS-00972`
...
The source now uses `Ace_Combat_3__Electrosphere__USA__Recompiled` as the only setup executable name. The batch source
